            ...
            <div className="mb-4 text-xs ">
                <div className="p-2 flex border-r border-b border-l border-gray-300 lg:border-l-0 rounded-lg lg:border-gray-300 bg-white shadow-[0_2px_4px_rgba(0,0,0,0.1)]">
                    ...
                    <div className="pl-2 w-3/5">
                        <div className='flex'>
                            <p className="text-gray-900 font-semibold text-xl mb-1">Name </p>
                            <p className='text-[rgba(0,0,0,0.55)] font-normal text-md w-max mt-2 ml-2 '>29/April-30/May</p>
                        </div>

                        <p className="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.</p>
                    ...
                    <div className=" w-1/3 relative mr-1">
                        <div className='absolute top-0 right-0'>
                            ...
                            <div className='text-[rgba(0,0,0,0.55)] font-semibold w-max absolute top-[2rem] right-[0.2rem] mt-1 flex justify-center items-center'><Image className='inline mr-1 ' src="/images/food-icon.png" width={16} height={16} /><p>Food</p></div>
                        </div>
