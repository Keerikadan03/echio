          ...
          <div className="w-1/2 order-0 bg-[#6B8DE6] z-10 rounded-l-xl">
            <div className="absolute top-[7.5rem] left-[28rem] bg-white w-max rounded-lg z-40 ">
              <Image
                ...
                className="rounded-xl drop-shadow-[4px_4px_4px_rgba(0,0,0,0.15)] p-1.5 w-[116px] h-[110px] "
                width={110}
                height={12}
                alt="model"
                srcset=""
            ...
            <div className="rounded-lg absolute top-[12rem] left-96 w-[237px] h-[249px] bg-gradient-to-r from-[#ffffff66] to-[#ffffff1a] shadow-[0_4px_20px_-1px_rgba(0,0,0,0.25)] drop-shadow-[rgba(0,0,0,0.25)] z-30 backdrop-blur-[20px]">
              <p className="flex justify-center text-white mt-[55px] text-xl text-bold">Selena Thomas</p>

              <div className="h-[114px] w-[186px] absolute top-[90px] left-7 rounded-xl bg-white">
            ...
            <div className="bg-white rounded-xl absolute top-[20rem] left-[12rem] w-[6.5rem] h-[3rem] z-20 ">
              <div className="grid grid-cols-3 pt-2.5 pl-2">
                <Image src="/images/smile.png" className=" " width={25} height={25} alt="model" srcset="" />
                <Image src="/images/wow.png" className="" width={25} height={25} alt="model" srcset="" />
                <Image src="/images/heart.png" className="" width={27} height={29} alt="model" srcset="" />
              </div>
            </div>
            <div className="bg-white rounded-xl absolute top-[26.5rem] left-[9rem] w-[350px] h-[103px] z-20">
              <div>
                <Image
                  ...
                  srcset=""
                />
                <p className="text-bold text-base relative top-[1.25rem] left-[11rem]">
                  <Image src="/images/youtube.png" className=" " width={22} height={22} alt="model" srcset="" />
                </p>
              </div>
            ...
            <div className=" py-5 px-10 bg-white rounded-r-xl shadow-[0_3px_8px_rgba(0,0,0,0.1)] h-[500px] drop-shadow-[rgba(0,0,0,0.1)]">
              ...
              <div className="">
                <div className="  mb-3">
                  <input
                    type="text"
                    className="rounded border w-full text-sm px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600"
                ...
                <div className="flex justify-between my-5">
                  ...
                  <p className="">
                    Have a account{" "}
                    <a href="/login" className="text-[#1976D2] ">
                      {" "}
                      Sign in
                    </a>
                  </p>
                ...
                <div className="flex justify-left ">
                  ...
                  <div className="mx-2">
                    <Image src="/images/apple.png" className="" width={36} height={36} alt="" srcset="" />
                  </div>
