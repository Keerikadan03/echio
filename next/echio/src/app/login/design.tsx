  ...
  return (
    <div className="w-1/2 bg-[#6B8DE6] rounded-l-xl">
      ...
      <div className="rounded-lg absolute top-[12rem] left-96 w-[237px] h-[229px] bg-gradient-to-r from-[#ffffff66] to-[#ffffff1a] shadow-[0_4px_20px_-1px_rgba(0,0,0,0.25)] drop-shadow-[rgba(0,0,0,0.25)] z-30 backdrop-blur-[20px]">
        <p className="flex justify-center text-white mt-[55px] text-xl font-Roboto text-bold w-[600] h-[25px]">Selena Thomas</p>

        <div className="h-[110px] w-[186px] absolute top-[90px] left-7 rounded-xl bg-white">
          <p className="flex justify-center items-center my-3 text-sm text-gray-600 font-Roboto">ENGAGEMENT</p>
      ...
      <div className="rounded-lg absolute top-[9.5rem] left-40 w-[11rem] h-[2.5rem] bg-gradient-to-r from-[#ffffff66] to-[#ffffff1a] shadow-[0_4px_20px_-1px_rgba(0,0,0,0.25)] drop-shadow-[rgba(0,0,0,0.25)] z-20 ">
        <p className="text-white flex justify-center items-center mt-3 font-Roboto">MAKES YOU VIRAL</p>
      </div>
      <div className="bg-white rounded-2xl absolute top-[12.25rem] left-[7rem] w-[295px] h-[95px] z-40">
        <div className="absolute">
          <Image
            ...
            alt="model"
          />
          <p className="text-bold text-base relative top-[14px] left-[8.75rem] font-Roboto">Instagram</p>
        </div>
        ...
        <p className=" text-s relative top-[1.1rem] left-[15rem] font-Roboto">Follow</p>

        <div className="absolute top-[1rem] left-[1rem] w-[90px] h-[60px] bg-[#F3F5FA] rounded-lg text-3xl text-bold flex justify-center items-center font-Inter">
          1M
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl absolute top-[25.5rem] left-[9rem] w-[350px] h-[103px] z-20">
        <div className="absolute">
          <Image
            src="/images/youtube-logo-hd-8.png"
            className="absolute top-[0.25rem] left-[6.12rem] "
            width={63}
            height={70}
            alt="model"
          />
          <p className="text-bold text-base relative top-[14px] left-[8.75rem] font-Roboto">Youtube</p>
        </div>
        ...
        <p className=" text-s absolute top-[1.35rem] left-[14.5rem] font-Roboto">SUBSCRIBERS</p>
