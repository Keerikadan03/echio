                ...
                <Box component="form" noValidate autoComplete="off" >
                    ...
                    <div className=' font-normal flex flex-col items-center w-full flex-1 p-20 text-xs '>
                        <div className='flex flex-row w-full h-3/4 rounded-2xl'>
                            ...
                            <form className='w-1/2' method="post" action="/api/auth/callback/credentials">
                                ...
                                <div className=' py-5 px-10 bg-white rounded-r-xl shadow-[0_3px_8px_rgba(0,0,0,0.1)] drop-shadow-[rgba(0,0,0,0.1)] '>
                                    ...
                                    <div className=''>
                                        ...
                                        <div className=' mt-5' >
                                            ...
                                            <button className="w-full flex justify-center items-center py-2 border border-[#1976D2] rounded bg-[#1976D2] text-white hover:bg-transparent hover:text-[#1976D2] hover:border-[#1976D2] shadow-[0_3px_1px_-2px_rgba(0,0,0,0.2),0_2px_2px_rgba(0,0,0,0.14),0_1px_5px_rgba(0,0,0,0.12)]" >SIGN IN</button>
                                        </div>
